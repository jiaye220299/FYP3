        ...
        bnv.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case R.id.item5:
                        Intent intent = new Intent(StaffProfile.this, StaffProfile.class);
                        intent.putExtra(EXTRA_MESSAGE, LoginID);
                        startActivity(intent);
                        break;
                    case R.id.item6:
                        Intent receive = new Intent(StaffProfile.this, MainActivity.class);
                ...
                if(validateEmail() && validatePass() && validatePhone() ){
                    ...
                    reference.child(LoginID).updateChildren(hashMap).addOnSuccessListener(new OnSuccessListener() {
                        ...
                        public void onSuccess(Object o) {
                            Toast.makeText(StaffProfile.this, "Update Successfully", Toast.LENGTH_SHORT).show();
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(StaffProfile.this, "Update Failure", Toast.LENGTH_SHORT).show();
                        }
                    });
                }}
        });
            ...
            try {
                storageReference.putFile(selectedImage).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        Toast.makeText(StaffProfile.this, "Uploaded", Toast.LENGTH_SHORT);
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(StaffProfile.this, "Not Uploaded", Toast.LENGTH_SHORT);
                    }
                });
            } catch (Exception e) {
                e.printStackTrace();
